...
module AirHead()
{
	...
	!difference()
	{
		union()
		{
			...
			union()
			{
				FanMountPlate(size=fan_size, thickness=t*2);
				
				intersection()
				{
					sphere(r=fan_size/2, h=5);
					translate([0,0,t*2]) rotate([180,0,0]) cylinder(r=100, h=100, $fn=5);
				}
			}

			// main ring
			translate([0, 0, 8.5])
			torus2(30, 40, thickness=0, sides=6, facets=6);
		}
		...
		translate([0, 0, 8.9])
		torus2(30+t*2, 40-t*4, sides=6, facets=6);
